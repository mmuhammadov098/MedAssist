...
HTML_PAGE = (
   ...
   "<div class='header'><img src='https://raw.githubusercontent.com/mmuhammadov098/MedAssist/main/logo.jpg' style='width:80px;height:80px;border-radius:16px;margin-bottom:10px;'><h1>MedAssist Pro</h1><p>AI yordamida dori malumotlari - 3 tilda</p></div>"
    ...
    "<script>"
    "var lang='uz';"
    "document.getElementById('btn-uz').onclick=function(){lang='uz';setActive('btn-uz');alert('Uzbek tanlandi');};"
    "document.getElementById('btn-ru').onclick=function(){lang='ru';setActive('btn-ru');alert('Russian tanlandi');};"
    "document.getElementById('btn-en').onclick=function(){lang='en';setActive('btn-en');alert('English tanlandi');};"
